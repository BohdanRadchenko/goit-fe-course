...
// let idx = users.indexOf(userToDelete);

// console.log(users.splice(idx, 1)) //  ["Lux", "Poly", "Jay", "Kiwi"]
// console.log('users :', users);
...
// let ix = users.indexOf(userToInsertBefore)
// console.log(users.splice(ix,0,"Kong")); //  ["Lux", "Poly", "Kong", "Jay", "Kiwi"]
// console.log('users :', users);
...
//============================== task 6 ===============
//Задание 8 Дано число n=1000. Делите его на 2 столько раз,
...
// const arr = [-10, -23, -42, 1, 2, 3, 4, -1, -2, -3, -4];
// let sum = 0;
// for (let i = 0; i < arr.length; i++) {
//  console.log('arr[i] :', arr[i]);
//  if (arr[i] > 0) {
...
// let number;
// do {
//   number = prompt('Enter number most 100');
//   if (Number(number) >= 100 ) {
//     alert('Thank you')
//     break;
//   } else if (number === null) {
//     alert('pressed "cencel" button');
//   } else {
//     alert('Try again');
//   }
...
// const numbers = [12, 15, 25, 37, 41, 62, 74, 83, 97, 105];
...
// let question = confirm(`We have Array with ${numbers.length} elements! Let's play the game?`);
// if (question) {
//   let name = prompt('Enter your name!');
//   let userInput = prompt(`Enter number from ${min} to ${max}`);
//   if (numbers.includes(Number(userInput))) {
//     alert(`${name} You won. Array have ${userInput} number`);
//   } else {
//     alert(`${name} Oh, You looose`);
//   }
// } else {
...
//     do {
//       userInput = prompt('Hello! Enter number');
...
//   `We have Array with ${numbers.length} elements! Let's play the game?`
// );
...
//   } else if(Number(userInput) < min) {
//     alert(`Число должно быть больше ${min}! Вы ввели: ${userInput}!`)
//   } else if (Number(userInput) > max) {
//     alert(`Число должно быть меньше ${max}! Вы ввели: ${userInput}!`)
//   }else {
...
//     alert(`Wrong password! You have ${attempts - i - 1} attempts!`);
//     i++;
//   } else {
//     alert("Wellcome");
//     break;
